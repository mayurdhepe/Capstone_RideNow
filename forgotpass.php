...
$result = $forgotDao->save($link, $user_id, $key, $time, $status);
...
$message .= "http://grad-project.host20.uk/RideNow/reset.php?user_id=$user_id&key=$key";
